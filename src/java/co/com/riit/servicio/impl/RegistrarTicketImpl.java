...
import co.com.riit.servicio.RegistrarTicket;
...
public class RegistrarTicketImpl implements RegistrarTicket {

    @GET
    @Produces({"application/json"})
    @Override
    public Ticket_TO registrarTicket(@QueryParam("idOportunidad") int idOportunidad,
        ...
        Ticket_TO ticket = new Ticket_TO(new Oportunidad_TO(idOportunidad), consulta, fi, new Time(hi.getTime()), solucion, fc, new Time(hc.getTime()), new Estado_TO(idEstado), cotizacion);
        TicketDAO ticketDao = new TicketDAOImpl();
        return ticketDao.registrarTicket(ticket);
