...
import co.com.riit.servicio.ConsultarTicketSitio;
 ...
 */
@Stateless
@Path("/consultarTicketSitio")
public class ConsultarTicketSitioImpl implements ConsultarTicketSitio{

    @GET
    @Produces({"application/json"})
    @Override
    public TicketSitio_TO consultarTicketSitio(@QueryParam("idTicket") int idTicket) throws Exception {
        TicketSitio_TO ticket = new TicketSitio_TO(idTicket);
        TicketSitioDAO ticketDao = new TicketSitioDAOImpl();
        return ticketDao.consultarTicketSitio(ticket);
    }    
}
