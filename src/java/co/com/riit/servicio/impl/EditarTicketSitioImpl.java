...
import co.com.riit.servicio.EditarTicketSitio;
 ...
 */
@Stateless
@Path("/editarTicketSitio")
public class EditarTicketSitioImpl implements EditarTicketSitio {

    @Override
    public TicketSitio_TO editarTicketSitio(@QueryParam("idTicket") int idTicket,
        ...
        TicketSitio_TO ticket = new TicketSitio_TO(idTicket, new Oportunidad_TO(idOportunidad), consulta, diagnostico, solucion, fi, new Time(hi.getTime()), fc, new Time(hc.getTime()), new Estado_TO(idEstado), foto1, foto2, foto3, foto4, foto5);
        TicketSitioDAO ticketDao = new TicketSitioDAOImpl();
        return ticketDao.editarTicketSitio(ticket);
    }
