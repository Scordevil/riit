...
import co.com.riit.servicio.ConsultarTicket;
...
public class ConsultarTicketImpl implements ConsultarTicket {

    @GET
    @Produces({"application/json"})
    @Override
    public Ticket_TO consultarTicket(@QueryParam("idTicket") int idTicket) throws Exception {
        Ticket_TO ticket = new Ticket_TO(idTicket);
        TicketDAO ticketDao = new TicketDAOImpl();
        return ticketDao.consultarTicket(ticket);
    }
}
