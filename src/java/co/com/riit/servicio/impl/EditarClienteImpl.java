...
import co.com.riit.servicio.EditarCliente;
...
public class EditarClienteImpl implements EditarCliente{
    ...
    @Override
    public Cliente_TO editarCliente(@QueryParam("idCliente") int idCliente, 
            @QueryParam("razonSocial") String razonSocial, 
            @QueryParam("nit") String nit, 
            @QueryParam("pagina") String paginaWeb, 
        ...
        return clienteDao.editarUsuario(cliente);
    }
